Rails.application.routes.draw do
  ...
  post '/cv_units/create_cv_unit/(:user_id)', to: "cv_units#create_cv_unit", as: "create_cv_unit"
  ...
  get '/cv_controller/download_all_odts/:id', to: "cvs#download_all_odts", as: "cv_controller_download_all_odts"
